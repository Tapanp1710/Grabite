...
var session = require('express-session'); // Ensure this is required
...
app.set('view engine', 'jade');  // Changed from pug to jade
...
app.get('/cart', (req, res) => {
    ...
    res.render('cart', { title: 'Your Cart', cartItems }); // Render cart.jade with cart items
});
...
// Error handler - To handle errors in development or production
app.use(function(err, req, res, next) {
    ...
    res.render('error'); // Make sure you have an error.jade file in your views
});
